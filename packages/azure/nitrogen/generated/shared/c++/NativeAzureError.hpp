...
namespace margelo::nitro::clarion::azure {
  ...
  /**
   * A struct which can be represented as a JavaScript object (NativeAzureError).
   */
  struct NativeAzureError final {
  public:
  ...
  public:
    NativeAzureError() = default;
    explicit NativeAzureError(std::string code, std::string message, bool recoverable): code(code), message(message), recoverable(recoverable) {}

  public:
    friend bool operator==(const NativeAzureError& lhs, const NativeAzureError& rhs) = default;
  };
...
namespace margelo::nitro {
  ...
  // C++ NativeAzureError <> JS NativeAzureError (object)
  template <>
  struct JSIConverter<margelo::nitro::clarion::azure::NativeAzureError> final {
    static inline margelo::nitro::clarion::azure::NativeAzureError fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::clarion::azure::NativeAzureError(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::clarion::azure::NativeAzureError& arg) {
