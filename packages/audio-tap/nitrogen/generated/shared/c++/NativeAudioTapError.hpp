...
namespace margelo::nitro::clarion::audio_tap {
  ...
  /**
   * A struct which can be represented as a JavaScript object (NativeAudioTapError).
   */
  struct NativeAudioTapError final {
  public:
  ...
  public:
    NativeAudioTapError() = default;
    explicit NativeAudioTapError(std::string code, std::string message, bool recoverable): code(code), message(message), recoverable(recoverable) {}

  public:
    friend bool operator==(const NativeAudioTapError& lhs, const NativeAudioTapError& rhs) = default;
  };
...
namespace margelo::nitro {
  ...
  // C++ NativeAudioTapError <> JS NativeAudioTapError (object)
  template <>
  struct JSIConverter<margelo::nitro::clarion::audio_tap::NativeAudioTapError> final {
    static inline margelo::nitro::clarion::audio_tap::NativeAudioTapError fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::clarion::audio_tap::NativeAudioTapError(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::clarion::audio_tap::NativeAudioTapError& arg) {
