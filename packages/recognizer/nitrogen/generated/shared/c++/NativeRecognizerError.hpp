...
namespace margelo::nitro::clarion::recognizer {
  ...
  /**
   * A struct which can be represented as a JavaScript object (NativeRecognizerError).
   */
  struct NativeRecognizerError final {
  public:
  ...
  public:
    NativeRecognizerError() = default;
    explicit NativeRecognizerError(std::string code, std::string message, bool recoverable): code(code), message(message), recoverable(recoverable) {}

  public:
    friend bool operator==(const NativeRecognizerError& lhs, const NativeRecognizerError& rhs) = default;
  };
...
namespace margelo::nitro {
  ...
  // C++ NativeRecognizerError <> JS NativeRecognizerError (object)
  template <>
  struct JSIConverter<margelo::nitro::clarion::recognizer::NativeRecognizerError> final {
    static inline margelo::nitro::clarion::recognizer::NativeRecognizerError fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::clarion::recognizer::NativeRecognizerError(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::clarion::recognizer::NativeRecognizerError& arg) {
