...
import com.margelo.nitro.clarion.recognizer.ClarionRecognizerOnLoad
 ...
 * registration runs before any JS code calls `createHybridObject('ClarionRecognizer')`.
 */
class ClarionRecognizerPackage : ReactPackage {
  init {
    ClarionRecognizerOnLoad.initializeNative()
  }
